...
- [~] **Prozor rezervisanja na stavci (2.11e):** cenovna stavka sa `booking_to = 31.12.2025` ne učestvuje u ponudi napravljenoj 5.1.2026, a učestvuje u onoj od 20.12.2025. _(9.9.2026: polje postoji i upisuje se — `booking_to = 2026-12-31` potvrđeno u bazi. **Primena u ponudi još ne postoji** — M5 ga pri sastavljanju ponude ne čita; zabeleženo kao poznat nedostatak, ne prećutano.)_
