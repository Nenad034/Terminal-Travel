...
**Verzija:** 1.5 — Deljenje izveštaja putem internog chata i mejla (5.9.2026, vlasnikov zahtev: "omogucite sada slanje izvestaja putem mejla, ili putem poruka... mislim i na infografik i tekstualno"). Ekran `/izvestaji` (M17) dobija dugme "Podeli izveštaj" sa dva kanala i dva formata, potvrđeno preko `AskUserQuestion` (vidi obrazloženje ispod tabele endpoint-a, poglavlje 7):
