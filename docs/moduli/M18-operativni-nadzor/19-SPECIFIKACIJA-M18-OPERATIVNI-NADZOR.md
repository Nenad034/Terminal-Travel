...
- **M17 panel ekran za M18** — implementiran (avgust 2026, M17 Faza 7): `apps/panel/src/app/(app)/nadzor/` (signali/kanali/trendovi/ai-troškovi), `docs/moduli/M17-interni-panel/11-SPECIFIKACIJA-M17-INTERNI-PANEL.md` poglavlje 4/7. Kod je napisan i pušovan; ručna live-provera protiv prave baze ostaje otvorena stavka (vidi M17 spec poglavlje 7, Faza 7 red).
