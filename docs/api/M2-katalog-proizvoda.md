...
```json
{
  "message": "Parametar \"channel\" je obavezan i mora biti jedna od vrednosti: B2C_SITE, B2B_PORTAL, MOBILE.",
  "error": "Bad Request",
  "statusCode": 400
}
```
...
```json
{
  "message": "Parametar \"lang\" mora biti jedan od podržanih jezika: sr, en, hr, sl, es, de, ru, fr.",
  "error": "Bad Request",
  "statusCode": 400
}
```
...
```json
{
  "message": "Proizvod mora imati srpski i engleski prevod pre objave (M2 spec §2.2)",
  "error": "Bad Request",
  "statusCode": 400
}
```
...
```json
{
  "productId": "1944adc0-...",
  "origin": "MANUAL_URL",
  "sourceUrl": "https://hotel-avala.example/o-nama"
}
```
...
```json
{
  ...
  "editedValue": { "text": "Ispravljen opis koji ide u katalog." }
}
```
...
```json
{
  "message": ["type must be one of the following values: ACCOMMODATION, PACKAGE, ..."],
  "error": "Bad Request",
  "statusCode": 400
}
```
