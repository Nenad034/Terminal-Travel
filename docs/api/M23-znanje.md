...
```json
{
  ...
  "destinationCity": "Solun",
  "translations": [
    { "languageCode": "sr", "title": "Solun — kratak vodič", "body": "Grad poznat po..." }
  ]
}
```
...
```json
{
  "id": "r1...",
  "status": "APPROVED",
  "reviewedBy": "u-direktor-1",
  "reviewedAt": "2026-08-16T09:05:00.000Z"
}
```
...
{
  "id": "q1...",
  "answer": "Hotel X — kratak vodič\n\nHotel ima spoljni bazen sa dečijim delom...",
...
```json
{
  "question": { "id": "q1...", "confidence": "NONE" },
  "message": "Zahtev je zabeležen. Za temu koja još nema članak, uređivač treba ručno da kreira novi Article..."
}
```
...
```json
{
  ...
  "subjectType": "DESTINATION",
  "shareToken": "9f2c...-token",
  "translation": { "languageCode": "sr", "title": "Solun — kratak vodič", "body": "..." }
}
```
