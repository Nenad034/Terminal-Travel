...
```json
{
  ...
  "segments": [
    ...
    },
    {
      ...
      "stayFrom": "2027-06-14",
      "stayTo": "2027-06-17",
      "notes": "Destinacija okvirno izabrana, hotel još nije potvrđen"
    }
  ]
}
```
...
```json
{
  "quote": {
    ...
    "items": [{ "id": "qi-1", "productId": "prod-hotel-1", "finalPrice": 84000 }]
  },
  ...
  "items": [
    {
      ...
      "occupancy": {
        "adults": 2,
        "children": 1,
        "roomConfig": [{ "roomTypeCode": "STD", "adults": 2, "children": 1, "childrenAges": [6] }]
      }
    }
  ],
...
{
  "statusCode": 400,
  "message": "Cena izabrane ponude je istekla (quote_expires_at) — ponovite pretragu (M5 spec §3.0b.3)."
}
```
...
{
  "statusCode": 400,
  "message": "Stavke ponude nose različit/nedefinisan tip_nastupanja — samouslužni kanal ne može sam da potvrdi rezervaciju (M5 spec §4.0a)."
}
```
...
```json
{
  "message": "Nova usluga mora biti istog tipa kao postojeća stavka (ACCOMMODATION) — izmena tipa proizvoda nije \"izmena usluge\" (M5 spec §6), pravi se nova rezervacija.",
  "statusCode": 400
}
```
...
```json
{
  "message": "Uslugu na postojeću rezervaciju dodaje isključivo interni tim agencije (M5 spec §6.7).",
  "statusCode": 403
}
```
...
```json
{
  "message": "Izlazna cena ne sme biti manja od nabavne — proverite da polja nisu zamenjena (M5 spec §6.7b).",
  "statusCode": 400
}
```
...
{
  "id": "booking-1",
  "voucherUrl": "http://localhost:3200/sr/rezervacija/vaucer/booking-1",
  "voucherOverrideApprovedBy": "user-1",
  "voucherOverrideReason": "...",
  "voucherOverrideAt": "2027-01-06T09:00:00.000Z"
}
```
      ...
      "items": [
        {
          ...
          "representative": {
            "fullName": "Ana Vodić",
            "phone": null,
            "email": "ana.vodic@terminal-travel.rs"
          }
        },
        {
...
[
  {
    "id": "note-2",
    "bookingId": "booking-1",
    "body": "Gosti preuzeti na aerodromu u 23:40.",
    "createdBy": "vodic-1",
    "origin": "FIELD_REP",
    "createdAt": "2027-01-07T11:22:00.000Z"
  },
  {
    "id": "note-1",
    "bookingId": "booking-1",
    ...
    "createdBy": "user-1",
    "origin": "OFFICE",
    "createdAt": "2027-01-06T09:15:00.000Z"
  }
]
```
...
```json
{
  "scopeType": "M3_SUPPLIER",
  "scopeId": "sup-1",
  "percentage": 15,
  "fixedAmount": 500,
  "fixedAmountCurrency": "EUR"
}
```
...
```json
{
  "id": "manifest-1",
  "status": "DRAFT",
  "referenceCode": "TT-000423",
  "supplierTypeSnapshot": "HOTEL",
  "language": "EN",
  "items": [{ "bookingItemId": "bi-1" }]
}
```
...
```json
{
  "id": "manifest-1",
  "status": "SENT",
  "sentAt": "2027-06-01T08:00:00.000Z",
  "sentBy": "user-4",
  "sentToEmail": "reservations@hotel-aegean.gr"
}
```
...
[
  {
    "id": "manifest-1",
    "supplierId": "sup-hotel-1",
    "status": "DRAFT",
    "referenceCode": "TT-000501",
    "items": [{ "bookingItemId": "bi-1" }]
  },
  {
    "id": "manifest-2",
    "supplierId": "sup-transfer-1",
    "status": "DRAFT",
    "referenceCode": "TT-000502",
    "items": [{ "bookingItemId": "bi-2" }]
  }
]
```
...
{
  "statusCode": 400,
  "message": "Opis greške na srpskom, sa referencom na poglavlje specifikacije.",
  "error": "Bad Request"
}
```
