...
- **Tekst na akcentnoj pozadini — pravilo po veličini, ne po modu:**
  - **Krupan/podebljan tekst** (glavno dugme, npr. "Potvrdi rezervaciju" — min. ~19px podebljano ili ~24px obično, WCAG definicija "velikog teksta") → **beo** (`#FFFFFF`), 3.57-3.68:1, formalno prolazi 3:1 prag koji važi za tu kategoriju teksta.
  - **Sitni elementi bez prostora za krupan tekst** (značka sa brojem, mala oznaka/chip) → **taman, skoro crn** (`#14140D`), 5-6:1, prolazi i strogi AA prag za običan tekst.
