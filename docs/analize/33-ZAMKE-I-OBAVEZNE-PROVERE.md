...
- *Provera:* kad se nalaz oslanja na posmatrano ponašanje ekrana, pre upisivanja uzroka: (1) nabrojati **sve** ulaze koji vode na isto mesto (grep po ruti/putanji, ne po imenu komponente) i proveriti svaki posebno — obim nalaza je koliko ih je pokvareno, ne "sve"; (2) potvrditi da fajl koji se optužuje stvarno učestvuje u prikazu — `grep -rn "from './<Fajl>'"` i pogledati da li je uvezena komponenta ili samo tip. Nalaz koji tvrdi "X je mrtav kod" mora imati pretragu svih uvoza kao dokaz, ne utisak.
