...
**5.11 Isti JWT ključ potpisuje više vrsta tokena, a proverivac gleda samo potpis — privremeni token radi kao pun pristupni**
...
**5.14 Nov oblik odgovora dodat na backend-u, a posrednik u frontend-u nije dopunjen — ekran ruši 500**
...
**5.13 E2E testovi šalju STVARNU poštu čim je SMTP podešen**
...
- *Uzrok:* dva koraka su preskočena. Prvo, poruka "nije pronađena" je viđena jednom, na ekranu, i uzeta kao dokaz o **celom** ponašanju liste — bez provere kojim je od više mogućih klikova dobijena. Drugo, pri traženju uzroka u kodu pogođen je fajl po **imenu** (`BookingsTable.tsx`) umesto po tome šta se stvarno renderuje — a taj fajl se ne renderuje nigde (živa tabela je `RealBookingsTable.tsx`, iz njega se uvozi samo jedan tip). Provera kroz stvaran ekran (zamka 5.13) sprečava suprotnu grešku — tvrdnju da nešto radi kad ne radi — ali ne sprečava pogrešan zaključak o *uzroku i obimu* onoga što je viđeno.
