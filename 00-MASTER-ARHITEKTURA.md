...
| **Faza 2 — Zakonska usklađenost** | M10 (Finansije: SEF/ESIR integracija), M11 (Compliance: eTurista/CIS, boravišna taksa, garancija putovanja). | Svaka rezervacija iz Faze 1 može zakonito da se fakturiše, fiskalizuje i prijavi nadležnim sistemima — bez ovoga agencija ne sme da posluje produkcijski, bez obzira koliko su drugi moduli razvijeni. |
