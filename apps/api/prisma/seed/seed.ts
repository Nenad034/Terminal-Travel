...
const SYSTEM_ROLE_SEED: { name: string; description: string }[] = [
  {
    name: SYSTEM_ROLES.VLASNIK,
    description: 'Pristup svemu, uključujući upravljanje ulogama i pojedinačnim izuzecima.',
  },
  {
    name: SYSTEM_ROLES.DIREKTOR,
    description: 'Pristup svemu osim promena vezanih za licencu agencije i vlasničku strukturu.',
  },
  {
    name: SYSTEM_ROLES.HR,
    description: 'M1 — upravljanje korisnicima i njihovim ulogama unutar tima.',
  },
  {
    name: SYSTEM_ROLES.SALES_MANAGER,
    description:
      'Uvid u rezervacije/CRM celog prodajnog tima, izveštaji o prodaji (M13, read-only).',
  },
  {
    name: SYSTEM_ROLES.PRODAJNI_AGENT,
    description:
      'Katalog (read), Rezervacije i CRM — ograničeno na sopstvene klijente/rezervacije.',
  },
  {
    name: SYSTEM_ROLES.RACUNOVODJA,
  ...
  {
    name: SYSTEM_ROLES.SUBAGENT_ADMIN,
    description:
      'M7 — portal nalog B2B subagenta (bilo kog nivoa), isključivo sopstvena mreža/rezervacije.',
  },
  {
    name: SYSTEM_ROLES.VODIC,
    description:
      'M9 — vodič na terenu, isključivo sopstveni dodeljeni itinerar i gosti na tim polascima, offline-first mobilna sinhronizacija.',
  },
];
...
const M1_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    ...
    { module: 'M1', resource: 'user', action: 'CREATE', description: 'Pozivanje novog korisnika' },
    {
      ...
      resource: 'user',
      action: 'EDIT',
      description: 'Izmena korisnika/dodela uloga',
    },
    {
      module: 'M1',
      resource: 'user',
      action: 'DELETE',
      description: 'Suspendovanje korisnika (meko gašenje)',
    },
    ...
    { module: 'M1', resource: 'role', action: 'EDIT', description: 'Izmena postojeće uloge' },
    {
      ...
      action: 'VIEW',
      description: 'Uvid u pojedinačne izuzetke korisnika',
    },
    {
      module: 'M1',
      resource: 'permission-override',
      action: 'CREATE',
      description: 'Dodela/oduzimanje pojedinačnog izuzetka',
    },
...
const M2_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    { module: 'M2', resource: 'product', action: 'VIEW', description: 'Uvid u katalog proizvoda' },
    {
      ...
      resource: 'product',
      action: 'CREATE',
      description: 'Ručno kreiranje CONTRACTED proizvoda',
    },
    { module: 'M2', resource: 'product', action: 'EDIT', description: 'Izmena proizvoda' },
    {
      ...
      resource: 'product',
      action: 'PUBLISH',
      description: 'Objava proizvoda / izmena vidljivosti po kanalu',
    },
    {
      module: 'M2',
      resource: 'product',
      action: 'DELETE',
      description: 'Arhiviranje proizvoda (meko gašenje)',
    },
    {
      module: 'M2',
      resource: 'product-translation',
      action: 'EDIT',
      description: 'Izmena prevoda proizvoda',
    },
    {
      module: 'M2',
      resource: 'product-content-import',
      action: 'CREATE',
      description: 'Pokretanje AI-potpomognutog uvoza sadržaja',
    },
    {
      module: 'M2',
      resource: 'product-content-import',
      action: 'VIEW',
      description: 'Uvid u uvoze sadržaja',
    },
    {
      module: 'M2',
      resource: 'product-content-import',
      action: 'REVIEW_FIELD',
      description: 'Odobri/odbij/izmeni izvučenu stavku uvoza',
    },
    // M2 spec §2.1c (dopuna 5.9.2026) — CRUD nad DestinationProfile (tip destinacije + aktivnosti).
    {
      module: 'M2',
      resource: 'destination-profile',
      action: 'VIEW',
      description: 'Uvid u profile destinacija (tip/aktivnosti)',
    },
    {
      module: 'M2',
      resource: 'destination-profile',
      action: 'CREATE',
      description: 'Kreiranje profila destinacije',
    },
    {
      module: 'M2',
      resource: 'destination-profile',
      action: 'EDIT',
      description: 'Izmena tipa destinacije / aktivnosti',
    },
  ];
...
const M3_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    ...
    { module: 'M3', resource: 'supplier', action: 'EDIT', description: 'Izmena dobavljača' },
    {
      ...
      action: 'VIEW',
      description: 'Uvid u kontakt-osobe dobavljača',
    },
    {
      module: 'M3',
      resource: 'supplier-contact',
      action: 'CREATE',
      description: 'Dodavanje kontakt-osobe dobavljača',
    },
    {
      module: 'M3',
      resource: 'supplier-contact',
      action: 'EDIT',
      description: 'Izmena kontakt-osobe dobavljača',
    },
    ...
    { module: 'M3', resource: 'contract', action: 'EDIT', description: 'Izmena ugovora' },
    {
      ...
      resource: 'contract',
      action: 'DELETE',
      description: 'Brisanje/raskid ugovora',
    },
    {
      module: 'M3',
      resource: 'contract-period',
      action: 'VIEW',
      description: 'Uvid u periode/alotman (uklj. preostali kapacitet)',
    },
    {
      module: 'M3',
      resource: 'contract-period',
    ...
    {
      module: 'M3',
      resource: 'pricelist-import',
      action: 'CREATE',
      description: 'Pokretanje AI uvoza cenovnika',
    },
    {
      module: 'M3',
      resource: 'pricelist-import',
      action: 'VIEW',
      description: 'Uvid u uvoze cenovnika',
    },
    {
      module: 'M3',
      resource: 'pricelist-import',
      action: 'APPROVE_ROW',
      description: 'Odobri/odbij red iz uvoza cenovnika',
    },
  ];
  ...
  [
    {
      ...
      action: 'VIEW',
      description: 'Uvid u konfiguraciju spoljnih provajdera',
    },
    {
      module: 'M4',
      resource: 'provider-config',
      action: 'CREATE',
      description: 'Dodavanje konfiguracije provajdera',
    },
    {
      module: 'M4',
      resource: 'provider-config',
      action: 'EDIT',
      description: 'Izmena konfiguracije/kredencijala provajdera',
    },
    {
      module: 'M4',
      resource: 'provider-call-log',
      action: 'VIEW',
      description: 'Uvid u operativni log poziva ka provajderima',
    },
  ];
  ...
  [
    {
      ...
      resource: 'itinerary',
      action: 'CREATE',
      description: 'Sastavljanje novog putovanja (Itinerary)',
    },
    {
      module: 'M5',
      resource: 'itinerary',
      action: 'VIEW',
      description: 'Uvid u sastavljena putovanja',
    },
    {
      module: 'M5',
      resource: 'itinerary',
      action: 'EDIT',
      description: 'Izmena segmenata putovanja / konverzija u Ponudu',
    },
    ...
    { module: 'M5', resource: 'quote', action: 'VIEW', description: 'Uvid u Ponude' },
    {
      ...
      resource: 'booking',
      action: 'CREATE',
      description: 'Potvrda rezervacije (Ponuda → Rezervacija)',
    },
    {
      module: 'M5',
      resource: 'booking',
      action: 'VIEW',
      description: 'Uvid u rezervacije i kalendar rezervacija',
    },
    {
      module: 'M5',
      resource: 'booking',
      action: 'MODIFY',
      description: 'Izmena rezervacije/statusa plaćanja',
    },
    {
      module: 'M5',
      resource: 'booking',
      action: 'CANCEL',
      description: 'Otkazivanje rezervacije/stavke',
    },
    ...
    // VIEW_ALL, sužavanje ide preko DENY override-a za pojedinca kome treba.
    {
      ...
      resource: 'booking',
      action: 'VIEW_ALL',
      description: 'Vidljivost svih rezervacija (ne samo sopstvenih po vlasništvu/zaduženju)',
    },
    // M5 spec §6.5 (31.8.2026) — vlasništvo i zaduženje rezervacije.
    {
      ...
      description:
        'Prenos vlasništva rezervacije (trenutni vlasnik ili Vlasnik/Direktor, nikad Sales Manager)',
    },
    {
      module: 'M5',
      resource: 'booking',
      action: 'TRANSFER_ASSIGNMENT',
      description: 'Predlog/otkazivanje predaje zaduženja rezervacije',
    },
    {
      module: 'M5',
      resource: 'booking',
      action: 'ACCEPT_ASSIGNMENT',
      description: 'Prihvatanje/odbijanje predloga predaje zaduženja rezervacije',
    },
    // M5 spec §4.6 (1.9.2026) — interne beleške uz rezervaciju; nikad AI nalog.
    {
      module: 'M5',
      resource: 'booking-note',
      action: 'CREATE',
      description: 'Dodavanje interne beleške uz rezervaciju',
    },
    {
      module: 'M5',
      resource: 'booking-note',
      action: 'DELETE',
      description: 'Brisanje interne beleške (autor sopstvenu, Vlasnik/Direktor bilo koju)',
    },
    ...
    {
      module: 'M5',
      resource: 'supplier-announcement-rule',
      action: 'VIEW',
      description: 'Uvid u pravila automatske pripreme najave dobavljaču',
    },
    {
      module: 'M5',
      resource: 'supplier-announcement-rule',
      action: 'EDIT',
      description: 'Izmena pravila automatske pripreme najave dobavljaču',
    },
    {
      module: 'M5',
      resource: 'voucher',
      action: 'OVERRIDE_ISSUE',
      description: 'Izdavanje vaučera bez pune uplate (izuzetak)',
    },
    {
      module: 'M5',
      resource: 'supplier-manifest',
      action: 'VIEW',
      description: 'Uvid u operativne liste za dobavljače',
    },
    {
      module: 'M5',
      resource: 'supplier-manifest',
      action: 'CREATE',
      description: 'Priprema nacrta operativne liste',
    },
    {
      module: 'M5',
      resource: 'supplier-manifest',
      action: 'SEND',
      description: 'Slanje operativne liste dobavljaču',
    },
    {
      module: 'M5',
      resource: 'supplier-change-notice',
      action: 'CREATE',
      description: 'Priprema nacrta najave izmene/storna dobavljaču',
    },
    {
      module: 'M5',
      resource: 'supplier-change-notice',
      action: 'SEND',
      description: 'Slanje najave izmene/storna dobavljaču',
    },
    {
      module: 'M5',
      resource: 'supplier-confirmation',
      action: 'CONFIRM',
      description: 'Ručna potvrda prijema od dobavljača (klik na predloženu vezu sa mejlom)',
    },
  ];
...
const M6_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    { module: 'M6', resource: 'client-account', action: 'VIEW', description: 'Uvid u nalogodavce' },
    {
      ...
      action: 'CREATE',
      description: 'Kreiranje nalogodavca',
    },
    { module: 'M6', resource: 'client-account', action: 'EDIT', description: 'Izmena nalogodavca' },
    {
      module: 'M6',
      resource: 'guest-profile',
      action: 'VIEW',
      description: 'Uvid u profile gostiju',
    },
    {
      module: 'M6',
      resource: 'guest-profile',
      action: 'CREATE',
      description: 'Kreiranje profila gosta',
    },
    {
      module: 'M6',
      resource: 'guest-profile',
      action: 'EDIT',
      description: 'Izmena profila gosta',
    },
    {
      module: 'M6',
      resource: 'loyalty-tier',
      action: 'VIEW',
      description: 'Uvid u nivoe lojalnosti',
    },
    {
      module: 'M6',
      resource: 'loyalty-tier',
      action: 'EDIT',
      description: 'Izmena definicija nivoa lojalnosti',
    },
    {
      module: 'M6',
      resource: 'loyalty-status',
      action: 'OVERRIDE',
      description: 'Ručna dodela nivoa lojalnosti mimo praga — obavezan razlog',
    },
    {
      module: 'M6',
      resource: 'communication-log',
      action: 'VIEW',
      description: 'Uvid u komunikaciju sa klijentima/gostima',
    },
    {
      module: 'M6',
      resource: 'communication-log',
      action: 'CREATE',
      description: 'Beleženje/slanje komunikacije',
    },
    {
      module: 'M6',
      resource: 'post-trip-survey',
      action: 'VIEW',
      description: 'Uvid u ankete posle putovanja',
    },
    // Dopuna 31.8.2026 (M1 §3.9a konvencija) — isti obrazac kao M5 §6.6.
    {
      ...
      action: 'VIEW_ALL',
      description:
        'Vidljivost svih nalogodavaca (ne samo onih čije rezervacije pozivalac poseduje/vodi)',
    },
    {
      module: 'M6',
      resource: 'post-trip-survey',
      action: 'VIEW_ALL',
      description: 'Vidljivost svih anketa (ne samo za sopstvene rezervacije)',
    },
  ];
  ...
  [
    {
      ...
      action: 'VIEW',
      description: 'Uvid u fiskalne dokumente',
    },
    {
      module: 'M10',
      resource: 'fiscal-document',
      action: 'CREATE_DRAFT',
      description: 'Priprema nacrta fiskalnog dokumenta (sme i AI agent)',
    },
    {
      module: 'M10',
      resource: 'fiscal-document',
      action: 'SUBMIT',
      description: 'Slanje ka SEF/ESIR i storno — nikad AI agent',
    },
    { module: 'M10', resource: 'payment', action: 'VIEW', description: 'Uvid u uplate' },
    {
      ...
      action: 'RECORD',
      description:
        'Ručan unos prijema uplate (BANK_TRANSFER/CASH/CARD_MANUAL/CHECK/ADMINISTRATIVE_BAN)',
    },
    { module: 'M10', resource: 'exchange-rate', action: 'VIEW', description: 'Uvid u kurseve' },
    {
      ...
      action: 'EDIT',
      description: 'Ručan unos dnevnog kursa',
    },
    {
      module: 'M10',
      resource: 'payment-gateway-config',
      action: 'VIEW',
      description: 'Uvid u konfiguraciju platnog provajdera',
    },
    {
      module: 'M10',
      resource: 'payment-gateway-config',
      action: 'EDIT',
      description: 'Podešavanje kredencijala platnog provajdera',
    },
    {
      module: 'M10',
      resource: 'supplier-obligation',
      action: 'VIEW',
      description: 'Uvid u obaveze prema dobavljačima',
    },
    {
      module: 'M10',
      resource: 'supplier-obligation',
      action: 'APPROVE',
      description: 'Odobrenje/plaćanje obaveze prema dobavljaču — nikad AI agent',
    },
    {
      module: 'M10',
      resource: 'supplier-payment-instruction',
      action: 'VIEW',
      description: 'Uvid u instrukcije za isplatu dobavljaču',
    },
    {
      module: 'M10',
      resource: 'supplier-payment-instruction',
      action: 'CREATE',
      description: 'Sastavljanje naloga za isplatu dobavljaču (ne i izvršenje)',
    },
    {
      module: 'M10',
      resource: 'supplier-payment-instruction',
      action: 'EXECUTE',
      description: 'Izvršenje isplate dobavljaču — nikad AI agent',
    },
    {
      module: 'M10',
      resource: 'refund-instruction',
      action: 'VIEW',
      description: 'Uvid u zahteve za refundaciju gosta',
    },
    {
      module: 'M10',
      resource: 'refund-instruction',
      action: 'CREATE',
      description: 'Sastavljanje zahteva za refundaciju gosta (ne i odobrenje/izvršenje)',
    },
    {
      module: 'M10',
      resource: 'refund-instruction',
      action: 'APPROVE',
      description: 'Odobrenje refundacije — nikad AI agent',
    },
    {
      module: 'M10',
      resource: 'refund-instruction',
      action: 'EXECUTE',
      description: 'Izvršenje refundacije — nikad AI agent',
    },
    {
      module: 'M10',
      resource: 'payment-terms-config',
      action: 'VIEW',
      description: 'Uvid u politiku akontacije/balansa',
    },
    {
      module: 'M10',
      resource: 'payment-terms-config',
      action: 'EDIT',
      description: 'Izmena globalne politike akontacije/balansa',
    },
    {
      module: 'M10',
      resource: 'client-payment-schedule',
      action: 'VIEW',
      description: 'Uvid u rokove naplate po rezervaciji',
    },
    {
      module: 'M10',
      resource: 'supplier-invoice-import',
      action: 'VIEW',
      description: 'Uvid u uvoze ulaznih faktura dobavljača',
    },
    {
      module: 'M10',
      resource: 'supplier-invoice-import',
      action: 'CREATE',
      description: 'Pokretanje uvoza/AI ekstrakcije ulazne fakture (sme i AI agent za ekstrakciju)',
    },
    {
      module: 'M10',
      resource: 'supplier-invoice-import',
      action: 'REVIEW',
      description: 'Potvrda/ručno mapiranje reda uvoza — nikad AI agent',
    },
    // Dopuna 31.8.2026 (M1 §3.9a konvencija) — isti obrazac kao M5 §6.6.
    {
      module: 'M10',
      resource: 'client-payment-schedule',
      action: 'VIEW_ALL',
      description: 'Vidljivost svih rokova naplate (ne samo za sopstvene rezervacije)',
    },
  ];
...
const M11_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    {
      module: 'M11',
      resource: 'travel-guarantee',
      action: 'VIEW',
      description: 'Uvid u trenutnu garanciju putovanja i iskorišćenost',
    },
    {
      module: 'M11',
      resource: 'travel-guarantee',
      action: 'EDIT',
      description: 'Ručna izmena/obnavljanje garancije putovanja — nikad AI agent',
    },
    {
      module: 'M11',
      resource: 'travel-guarantee-registration',
      action: 'VIEW',
      description: 'Uvid u CIS registracije garancije po rezervaciji',
    },
    {
      module: 'M11',
      resource: 'travel-guarantee-registration',
      action: 'RETRY',
      description: 'Ručno ponavljanje CIS registracije/skidanja opterećenja',
    },
    {
      module: 'M11',
      resource: 'inspection-export',
      action: 'CREATE',
      description: 'Generisanje izvoza evidencije za inspekciju',
    },
  ];
  ...
  [
    {
      ...
      resource: 'subagent',
      action: 'VIEW',
      description: 'Uvid u subagente (ceo lanac za agenciju, sopstveni+deca za SUBAGENT_ADMIN)',
    },
    {
      module: 'M7',
      resource: 'subagent',
      action: 'CREATE',
      description: 'Registracija novog Tier 1 subagenta',
    },
    {
      module: 'M7',
      resource: 'subagent',
      action: 'APPROVE',
      description: 'Odobravanje subagenta (PENDING_APPROVAL → ACTIVE) — postavlja kreditni limit',
    },
    {
      module: 'M7',
      resource: 'subagent',
      action: 'EDIT',
      description: 'Izmena kreditnog limita/statusa subagenta',
    },
    {
      module: 'M7',
      resource: 'subagent',
      action: 'MANAGE_OWN_NETWORK',
      description:
        'Upravljanje sopstvenim direktnim sub-subagentima (kreiranje, provizija, pragovi obima)',
    },
    {
      module: 'M7',
      resource: 'commission-rebate',
      action: 'VIEW',
      description: 'Uvid u retroaktivne rabate provizije',
    },
    {
      module: 'M7',
      resource: 'commission-rebate',
      action: 'APPROVE',
      description: 'Odobrenje/odbijanje rabata — nikad AI agent',
    },
  ];
  ...
  [
    {
      ...
      action: 'VIEW',
      description: 'Uvid u ugovore sa klijentima',
    },
    {
      module: 'M20',
      resource: 'client-contract',
      action: 'ACCEPT',
      description:
        'Ručno evidentiranje prihvatanja (WET_SIGNATURE_SCAN) — gost prihvata sam kroz M8 tok, ne kroz ovu dozvolu',
    },
    {
      module: 'M20',
      resource: 'client-contract',
      action: 'VOID',
      description: 'Poništavanje ugovora — nikad AI agent',
    },
    // Dopuna 31.8.2026 (M1 §3.9a konvencija) — isti obrazac kao M5 §6.6.
    {
      module: 'M20',
      resource: 'client-contract',
      action: 'VIEW_ALL',
      description: 'Vidljivost svih ugovora (ne samo za sopstvene rezervacije)',
    },
  ];
  ...
  [
    {
      ...
      resource: 'ticket',
      action: 'VIEW',
      description: 'Uvid u tikete (svi za interni tim, sopstveni za Gosta/subagenta)',
    },
    {
      module: 'M14',
      resource: 'ticket',
      action: 'CREATE',
      description: 'Otvaranje tiketa i dodavanje sopstvene (REQUESTER) poruke',
    },
    {
      module: 'M14',
      resource: 'ticket',
      action: 'RESPOND',
      description:
        'Izmena statusa/prioriteta/dodele, STAFF/AI_DRAFT poruke, mark-sent — nikad Gost/subagent',
    },
    ...
    // Ticket.assigned_to = pozivalac (nema owner_id/assigned_to_id par kao Booking, samo dodela).
    {
      ...
      action: 'VIEW_ALL',
      description:
        'Vidljivost svih tiketa internog tima (ne samo onih na kojima je pozivalac zadužen)',
    },
  ];
...
const M13_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    {
      module: 'M13',
      resource: 'report:profitability',
      action: 'VIEW',
      description:
        'Profitabilnost po destinaciji/dobavljaču/kanalu; gejtuje i ručno pokretanje rekonsilijacije',
    },
    { module: 'M13', resource: 'report:sales', action: 'VIEW', description: 'Izveštaj prodaje' },
    {
      ...
      action: 'VIEW',
      description: 'Finansijski izveštaji (FactPayment)',
    },
    {
      module: 'M13',
      resource: 'report:occupancy',
      action: 'VIEW',
      description: 'Operativna statistika smeštaja (broj osoba, noćenja, prodate sobe)',
    },
    {
      module: 'M13',
      resource: 'report:dynamic',
      action: 'VIEW',
      description: 'Dinamički drill-down izveštaj sa korisnički sastavljivim redosledom dimenzija',
    },
    {
      module: 'M13',
      resource: 'report:marketing',
      action: 'VIEW',
  ...
  [
    {
      ...
      resource: 'content',
      action: 'VIEW',
      description: 'Uvid u marketinški sadržaj/kalendar',
    },
    {
      module: 'M12',
      resource: 'content',
      action: 'CREATE_DRAFT',
      description:
        'Ručno kreiranje/izmena nacrta i prevoda — AI nacrt ide mimo dozvola (event pretplatnik)',
    },
    {
      module: 'M12',
      resource: 'content',
      action: 'APPROVE_PUBLISH',
      description: 'Ljudsko odobrenje pre objave — nikad AI agent',
    },
    {
      module: 'M12',
      resource: 'channel-config',
      action: 'VIEW',
      description: 'Uvid u konfiguraciju distribucionih kanala',
    },
    {
      module: 'M12',
      resource: 'channel-config',
      action: 'EDIT',
      description: 'Izmena konfiguracije/kredencijala distribucionih kanala',
    },
  ];
  ...
  [
    {
      ...
      resource: 'mcp-client',
      action: 'VIEW',
      description: 'Uvid u registrovane MCP klijente',
    },
    {
      module: 'M16',
      resource: 'mcp-client',
      action: 'MANAGE',
      description:
        'Registracija/aktivacija/suspendovanje MCP klijenta (implementaciona dopuna avgust 2026)',
    },
    {
      module: 'M16',
      resource: 'mcp-client',
      action: 'APPROVE_READ_WRITE',
      description: 'Odobrenje prelaska READ_ONLY→READ_WRITE — nikad automatski',
    },
  ];
...
const M9_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    {
      module: 'M9',
      resource: 'field-itinerary',
      action: 'VIEW',
      description: 'Uvid u sopstveni dodeljeni itinerar (GET /mobile/staff/my-itinerary)',
    },
    {
      module: 'M9',
      resource: 'field-checkin',
      action: 'CREATE',
      description: 'Slanje FieldCheckIn zapisa pri sinhronizaciji (POST /mobile/staff/sync)',
    },
    {
      module: 'M9',
      resource: 'field-incident',
      action: 'CREATE',
      description: 'Slanje FieldIncidentNote zapisa pri sinhronizaciji (POST /mobile/staff/sync)',
    },
    // §3.2 dopuna (1.9.2026) — kancelarijski uvid u prijave sa terena po rezervaciji.
    {
      ...
      resource: 'field-checkin',
      action: 'VIEW',
      description: 'Uvid u prijave sa terena za rezervaciju (GET /mobile/staff/check-ins)',
    },
  ];
...
const M15_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    {
      module: 'M15',
      resource: 'module-activation',
      action: 'VIEW',
      description: 'Uvid u status aktivacije M15 gate-ova (npr. M15_OMNISEARCH)',
    },
    {
      module: 'M15',
      resource: 'module-activation',
      action: 'ACTIVATE',
      description: 'Ljudska potvrda prelaska gate-a u ACTIVATED — nikad AI agent',
    },
    {
      module: 'M15',
      resource: 'agent-action-type',
      action: 'VIEW',
      description: 'Uvid u registar akcija AI agenata (poglavlje 4) i njihov nivo autonomije',
    },
    {
      module: 'M15',
      resource: 'agent-action-type',
      action: 'EDIT',
      description: 'Izmena nivoa autonomije registrovane akcije — nikad AI agent',
    },
    {
      module: 'M15',
      ...
      action: 'VIEW',
      description:
        'Agregovan prikaz PROPOSE_THEN_APPROVE stavki koje čekaju ljudsko odobrenje kroz sve module',
    },
  ];
...
const M15_BI_TERMINAL_PERMISSION: {
  module: string;
  resource: string;
  action: string;
  description: string;
}[] = [
  {
    ...
    action: 'VIEW',
    description:
      'Terminal panel — kontrolisan, samo-za-čitanje AI agent za poslovna pitanja (poglavlje 6.9). Isključivo Vlasnik, ne Direktor.',
  },
];
...
const M18_PERMISSIONS: { module: string; resource: string; action: string; description: string }[] =
  [
    {
      module: 'M18',
      resource: 'health-signal',
      action: 'VIEW',
      description: 'Uvid u detektovane operativne signale (kvarovi/nepravilnosti kroz sve module)',
    },
    {
      module: 'M18',
      resource: 'notification-channel',
      action: 'VIEW',
      description: 'Uvid u spoljne kanale obaveštavanja (Telegram/email/in-app)',
    },
    {
      module: 'M18',
      resource: 'notification-channel',
      action: 'EDIT',
      description: 'Izmena/kreiranje kanala obaveštavanja',
    },
    {
      module: 'M18',
      resource: 'weekly-review',
      action: 'VIEW',
      description: 'Uvid u nedeljne sveobuhvatne preglede, uklj. ručno pokretanje van rasporeda',
    },
    {
      module: 'M18',
      resource: 'trend-suggestion',
      action: 'VIEW',
      description: 'Uvid u predloge trendova',
    },
    {
      module: 'M18',
      resource: 'trend-suggestion',
      action: 'APPROVE',
      description: 'Odobrenje/odbijanje predloga trenda pre ulaska u Dodatak A Master dokumenta',
    },
    {
      module: 'M18',
      resource: 'agent-invocation-log',
      action: 'VIEW',
      description: 'Uvid u log poziva jezičkom modelu (potrošnja/trošak po agentu)',
    },
    {
      module: 'M18',
      resource: 'provider-health',
      action: 'VIEW',
      description: 'Uvid u trenutno stanje (latencija/dostupnost) po dobavljaču/provajderu',
    },
    {
      module: 'M18',
      resource: 'ai-provider-quota',
      action: 'VIEW',
      description: 'Uvid u potrošnju naspram kvota/budžeta po AI provajderu',
    },
    {
      module: 'M18',
      resource: 'ai-provider-quota',
      action: 'OVERRIDE',
      description: 'Ručan povratak iz DEGRADED u NORMAL pre isteka perioda',
    },
    {
      module: 'M18',
      resource: 'ai-agent-budget',
      action: 'VIEW',
      description: 'Uvid u budžet po pojedinačnom AI agentu',
    },
    {
      module: 'M18',
      resource: 'ai-agent-budget',
      action: 'EDIT',
      description: 'Izmena/kreiranje budžeta pojedinačnog AI agenta',
    },
    {
      module: 'M18',
      resource: 'process-map',
      action: 'VIEW',
      description: 'Uvid u živu procesnu mapu (dopunjeno 29.8.2026, M18 spec §9a)',
    },
  ];
  ...
  [
    {
      ...
      action: 'CREATE',
      description: 'Kreiranje internog DIRECT/GROUP razgovora',
    },
    {
      module: 'M19',
      resource: 'conversation',
      action: 'VIEW',
      description: 'Uvid u sopstvene interne razgovore/prisustvo tima',
    },
    {
      module: 'M19',
      resource: 'conversation',
      action: 'SEND_MESSAGE',
      description: 'Slanje poruke u interni razgovor',
    },
    {
      module: 'M19',
      resource: 'supplier-conversation',
      action: 'VIEW',
      description: 'Uvid u EXTERNAL_SUPPLIER razgovor — samo uz SupplierConversationAccess (§9.4)',
    },
    {
      module: 'M19',
      resource: 'supplier-conversation',
      action: 'SEND_MESSAGE',
      description: 'Slanje poruke dobavljaču — samo uz SupplierConversationAccess (§9.4)',
    },
    {
      module: 'M19',
      resource: 'supplier-conversation',
      action: 'GRANT_ACCESS',
      description:
        'Dodela/oduzimanje pristupa zaposlenom EXTERNAL_SUPPLIER razgovoru, pokretanje portal pozivnice dobavljaču',
    },
  ];
  ...
  [
    {
      ...
      action: 'VIEW',
      description: 'Uvid u objavljene članke namenjene internom timu',
    },
    {
      module: 'M21',
      resource: 'article:subagent',
      action: 'VIEW',
      description: 'Uvid u objavljene članke namenjene B2B subagentima',
    },
    {
      module: 'M21',
      resource: 'article:business',
      action: 'VIEW',
      description: 'Uvid u objavljene članke namenjene korporativnim self-service klijentima',
    },
    {
      module: 'M21',
      ...
      action: 'VIEW',
      description:
        'Uvid u objavljene članke namenjene anonimnim/pojedinačnim (INDIVIDUAL) B2C gostima',
    },
    {
      module: 'M21',
      resource: 'article:staff',
      action: 'EDIT',
      description: 'Kreiranje/izmena nacrta članaka za interni tim',
    },
    {
      module: 'M21',
      resource: 'article:staff',
      action: 'PUBLISH',
      description: 'Objava članka za interni tim (isključivo Direktor/Vlasnik)',
    },
    {
      module: 'M21',
      resource: 'article:subagent',
      action: 'EDIT',
      description: 'Kreiranje/izmena nacrta članaka za B2B subagente',
    },
    {
      module: 'M21',
      resource: 'article:subagent',
      action: 'PUBLISH',
      description: 'Objava članka za B2B subagente (isključivo Direktor/Vlasnik)',
    },
    {
      module: 'M21',
      resource: 'article:business',
      action: 'EDIT',
      description: 'Kreiranje/izmena nacrta članaka za korporativne klijente',
    },
    {
      module: 'M21',
      resource: 'article:business',
      action: 'PUBLISH',
      description: 'Objava članka za korporativne klijente (isključivo Direktor/Vlasnik)',
    },
    {
      module: 'M21',
      resource: 'article:public',
      action: 'EDIT',
      description: 'Kreiranje/izmena nacrta članaka za anonimne/pojedinačne B2C goste',
    },
    {
      module: 'M21',
      resource: 'article:public',
      action: 'PUBLISH',
      description: 'Objava članka za anonimne/pojedinačne B2C goste (isključivo Direktor/Vlasnik)',
    },
    {
      module: 'M21',
      resource: 'suggestion',
      action: 'APPROVE',
      description: 'Odobrenje/odbijanje AI predloga novog članka baze znanja',
    },
    {
      module: 'M21',
      resource: 'question-log',
      action: 'VIEW',
      description:
        'Uvid u istoriju pitanja AI asistentu radi kvaliteta sadržaja i bezbednosnog pregleda',
    },
  ];
  ...
  [
    {
      ...
      resource: 'mailbox',
      action: 'VIEW',
      description: 'Uvid u listu sandučadi (bez pristupa sadržaju niti bez MailboxAccess)',
    },
    {
      module: 'M22',
      resource: 'mailbox',
      action: 'CREATE',
      description: 'Kreiranje novog sandučeta (SHARED/PERSONAL) i konekcije provajdera',
    },
    {
      module: 'M22',
      resource: 'mailbox',
      action: 'EDIT',
      description: 'Izmena podešavanja sandučeta',
    },
    {
      module: 'M22',
      resource: 'mailbox-access',
      action: 'GRANT',
      description: 'Pojedinačna dodela/oduzimanje pristupa (VIEW/REPLY) sandučetu',
    },
    {
      module: 'M22',
      resource: 'email-thread',
      action: 'VIEW',
      description: 'Uvid u niti — samo za sandučad za koja postoji MailboxAccess (§2.2)',
    },
    {
      module: 'M22',
      resource: 'email-thread',
      action: 'REPLY',
      description: 'Odgovaranje/slanje/povezivanje niti — samo uz REPLY MailboxAccess (§2.2)',
    },
    {
      module: 'M22',
      resource: 'email-thread',
      action: 'CONVERT_TO_TICKET',
      description: 'Konverzija niti u M14 tiket — isti krug kao REPLY',
    },
  ];
  ...
  [
    {
      ...
      action: 'VIEW',
      description:
        'Uvid u punu listu objavljenih članaka baze znanja (interni tim i SUBAGENT_ADMIN, bez razdvajanja publike)',
    },
    {
      module: 'M23',
      resource: 'article',
      action: 'EDIT',
      description: 'Kreiranje/izmena nacrta članaka, pokretanje AI istraživanja',
    },
    {
      module: 'M23',
      resource: 'article',
      action: 'PUBLISH',
      description: 'Objava članka — nikad AI agent (M23 spec §6/§9)',
    },
    {
      module: 'M23',
      resource: 'article-source',
      action: 'APPROVE',
      description: 'Odobrenje/odbijanje kandidata izvora — nikad AI agent (§4b)',
    },
    {
      module: 'M23',
      resource: 'article-revision',
      action: 'APPROVE',
      description: 'Odobrenje/odbijanje predložene revizije sadržaja — nikad AI agent (§2.4/§4c)',
    },
    {
      module: 'M23',
      resource: 'question-log',
      action: 'VIEW',
      description: 'Uvid u istoriju pitanja AI asistentu radi kvaliteta sadržaja',
    },
  ];
...
async function seedBootstrapVlasnik() {
  ...
  if (provided) {
    ...
    console.log(
      '  ^ prikazuje se SAMO sada — zapišite je. Promena ide kroz „zaboravljena lozinka“.',
    );
  }
...
async function seedM15Omnisearch() {
  ...
  if (existingActionType) {
    await prisma.agentActionType.update({
      where: { id: existingActionType.id },
...
async function upsertAgentActionType(
...
async function seedM15ActionRegistry() {
  const rows: {
    ...
    {
      moduleCode: 'M3',
      actionCode: 'contract_period.release_warning',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote: 'M3 poglavlje 4.1',
    },
    {
      moduleCode: 'M3',
      actionCode: 'pricelist_import.extract',
      tier: 'AUTONOMOUS',
      sourceNote: 'M3 poglavlje 4.2.4',
    },
    {
      moduleCode: 'M3',
    ...
    {
      moduleCode: 'M3',
      actionCode: 'contract_period.low_capacity_alert',
      tier: 'AUTONOMOUS',
      sourceNote:
        'M3 poglavlje 4.3 — čisto informativan signal na 1–2 preostale jedinice, ne blokira prodaju',
    },
    {
      moduleCode: 'M5',
      actionCode: 'supplier_manifest.draft',
      tier: 'AUTONOMOUS',
      sourceNote:
        'M5 poglavlje 8.4, 8.7 — priprema nacrta i njeno prioritetno isticanje ostaju čisto informativni',
    },
    {
      moduleCode: 'M5',
      actionCode: 'supplier_manifest.send',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote: 'M5 poglavlje 8.4',
    },
    {
      moduleCode: 'M5',
      actionCode: 'booking_item.cancel_duplicate_check',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote:
        'M5 poglavlje 6.4 — deterministički fuzzy-match, upozorenje pre storna zahteva svesnu potvrdu operatera',
    },
    {
      moduleCode: 'M6',
      actionCode: 'communication.draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M6 poglavlje 4',
    },
    {
      moduleCode: 'M6',
      actionCode: 'communication.send_with_price_or_obligation',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote: 'M6 poglavlje 4',
    },
    {
      moduleCode: 'M7',
      actionCode: 'commission_rebate.calculate_draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M7 poglavlje 3.2',
    },
    {
      moduleCode: 'M7',
    ...
    {
      moduleCode: 'M7',
      actionCode: 'subagent_chat.search',
      tier: 'AUTONOMOUS',
      sourceNote: 'M7 poglavlje 2.0.4c — čitanje kataloga, isti obim kao portal',
    },
    {
      moduleCode: 'M7',
      actionCode: 'subagent_chat.quote_draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M7 poglavlje 2.0.4c — deterministička cena, ništa obavezujuće',
    },
    {
      moduleCode: 'M7',
      actionCode: 'subagent_chat.booking_confirm',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote: 'M7 poglavlje 2.0.4c — odobrava isključivo subagent sopstvenim nalogom (Gejt A)',
    },
    {
      moduleCode: 'M10',
      actionCode: 'fiscal_document.draft',
      tier: 'AUTONOMOUS',
    ...
    {
      moduleCode: 'M11',
      actionCode: 'travel_guarantee.expiry_reminder',
      tier: 'AUTONOMOUS',
      sourceNote: 'M11 poglavlje 4',
    },
    {
      moduleCode: 'M11',
      actionCode: 'travel_guarantee.edit',
      tier: 'NEVER_AUTONOMOUS',
      sourceNote: 'M11 poglavlje 4',
    },
    {
      moduleCode: 'M11',
      actionCode: 'travel_guarantee.utilization_warning',
      tier: 'AUTONOMOUS',
      sourceNote: 'M11 poglavlje 4.2 — upozorenje na 80% praga, ne tvrda blokada',
    },
    {
      moduleCode: 'M12',
      actionCode: 'content.draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M12 poglavlje 3',
    },
    {
      moduleCode: 'M12',
    ...
    {
      moduleCode: 'M13',
      actionCode: 'insight.surface_trend',
      tier: 'AUTONOMOUS',
      sourceNote: 'M13 poglavlje 5',
    },
    {
      moduleCode: 'M14',
      actionCode: 'ticket_response.draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M14 poglavlje 4',
    },
    {
      moduleCode: 'M14',
    ...
    {
      moduleCode: 'M14',
      actionCode: 'complaint.escalate_notify',
      tier: 'AUTONOMOUS',
      sourceNote: 'M14 poglavlje 3.1 — čisto informativna eskalacija (ZZP rok), ne izvršenje',
    },
    {
      moduleCode: 'M20',
      actionCode: 'client_contract.generate_draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M20 poglavlje 4',
    },
    {
      moduleCode: null,
    ...
    {
      moduleCode: null,
      actionCode: 'license_data.edit',
      tier: 'NEVER_AUTONOMOUS',
      sourceNote: 'poglavlje 7 Master dokumenta',
    },
    {
      moduleCode: 'M18',
      actionCode: 'trend_research.draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M18 poglavlje 5',
    },
    {
      moduleCode: 'M18',
      actionCode: 'trend_research.apply_to_docs',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote: 'M18 poglavlje 5',
    },
    {
      moduleCode: 'M18',
      actionCode: 'health_signal.detect_and_notify',
      tier: 'AUTONOMOUS',
      sourceNote: 'M18 poglavlje 2 — čisto informativno, isporuka upozorenja nije poslovna odluka',
    },
    {
      moduleCode: 'M21',
      ...
      tier: 'AUTONOMOUS',
      sourceNote:
        'M21 poglavlje 5.2 — isključivo pretraga objavljenog sadržaja, bez pristupa živim podacima',
    },
    {
      moduleCode: 'M21',
      actionCode: 'help_escalation.create_ticket',
      tier: 'AUTONOMOUS',
      sourceNote:
        'M21 poglavlje 5.3 — korisnik koji pita sam potvrđuje eskalaciju sopstvenog pitanja',
    },
    {
      moduleCode: 'M21',
      actionCode: 'help_article_suggestion.draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M21 poglavlje 5.4 — čisto pripremni nacrt iz obrasca ponovljenih pitanja',
    },
    {
      moduleCode: 'M21',
      actionCode: 'help_article_suggestion.approve',
      tier: 'PROPOSE_THEN_APPROVE',
      sourceNote: 'M21 poglavlje 5.4',
    },
    {
      moduleCode: 'M23',
      actionCode: 'knowledge_question.answer',
      tier: 'AUTONOMOUS',
      sourceNote: 'M23 poglavlje 3.2 — isključivo pretraga objavljenog sadržaja',
    },
    {
      moduleCode: 'M23',
      actionCode: 'knowledge_article.research_draft',
      tier: 'AUTONOMOUS',
      sourceNote: 'M23 poglavlje 4c — priprema ArticleRevision nacrt iz odobrenih izvora',
    },
    {
      moduleCode: 'M23',
      actionCode: 'knowledge_article.publish',
      tier: 'NEVER_AUTONOMOUS',
      sourceNote:
        'M23 poglavlje 6 — isto tako article-source.approve/article-revision.approve, nikad AI',
    },
    {
      moduleCode: null,
      actionCode: 'omnisearch.external_review_lookup',
      tier: 'AUTONOMOUS',
      sourceNote:
        'poglavlje 6.5.6 — čisto informativno, ograničeno na whitelist ExternalReviewSource',
    },
    {
      moduleCode: 'M19',
      ...
      tier: 'AUTONOMOUS',
      sourceNote:
        'M19 poglavlje 9.5 — isključivo sažimanje/nacrt, nikad slanje (message.send ostaje ljudska radnja)',
    },
    {
      moduleCode: 'M22',
...
async function seedM5CalendarMockBookings() {
  ...
  if (accommodationProducts.length === 0 || !markupRule || !clientAccount) {
    console.log(
      'seedM5CalendarMockBookings: preskočeno (nema još ACCOMMODATION proizvoda/MarkupRule/ClientAccount u bazi)',
    );
    return;
  }
  ...
  const ENTRIES: MockEntry[] = [
    {
      ...
      fromOffset: -12,
      toOffset: -8,
      guests: ['Marko Marković', 'Ana Marković'],
      unitCount: 1,
    ...
    },
    {
      ...
      fromOffset: -5,
      toOffset: 0,
      guests: ['Jovan Jovanović', 'Milica Jovanović', 'Uroš Jovanović'],
      unitCount: 1,
      itemStatus: 'CONFIRMED',
      bookingStatus: 'CONFIRMED',
      price: 68000,
    ...
    },
    {
      ...
      fromOffset: 0,
      toOffset: 0,
      guests: ['Nikola Nikolić', 'Jelena Nikolić'],
      unitCount: 1,
    ...
    },
    {
      ...
      fromOffset: 3,
      toOffset: 7,
      guests: ['Stefan Stefanović', 'Ivana Stefanović', 'Luka Stefanović', 'Mila Stefanović'],
      unitCount: 1,
      itemStatus: 'CONFIRMED',
      bookingStatus: 'CONFIRMED',
      price: 89000,
    },
    {
      ...
      fromOffset: -1,
      toOffset: 3,
      guests: ['Vladimir Vasić', 'Tamara Vasić'],
      unitCount: 1,
      itemStatus: 'CONFIRMED',
      bookingStatus: 'CONFIRMED',
      price: 71000,
    },
    {
      ...
      fromOffset: 7,
      toOffset: 12,
      guests: ['Dragan Dragić', 'Snežana Dragić', 'Miloš Dragić', 'Sara Dragić'],
      unitCount: 2,
      itemStatus: 'CONFIRMED',
      bookingStatus: 'CONFIRMED',
      price: 132000,
    },
    {
      ...
      fromOffset: 1,
      toOffset: 1,
      guests: ['Filip Filipović', 'Sofija Filipović'],
      unitCount: 1,
      itemStatus: 'CONFIRMED',
      bookingStatus: 'CONFIRMED',
      price: 9000,
  ...
  console.log(
    `seedM5CalendarMockBookings: ${ENTRIES.length} mock rezervacija (TT-MOCK-CAL-*) proverenih/ubačenih`,
  );
}
...
async function seedM22SupplierUnifiedInbox() {
  ...
  console.log(
    `seedM22SupplierUnifiedInbox: jedinstveno sanduče za dobavljače ${mailbox.address} (${mailbox.id})`,
  );
}
