...
const KATALOG: Drzava[] = [
  {
    ...
    destinacije: [
      {
        city: 'Sitonija',
        hotel: 'Blue Horizon Sithonia',
        stars: 4,
        price: 96,
        boards: ['HB', 'BB', 'FB'],
        amenities: [...MORE_PORODICNO, 'BEACH_PEBBLE'],
        airport: 'Solun',
      },
      {
        city: 'Kasandra',
        hotel: 'Aegean Breeze Resort',
        stars: 4,
        price: 88,
        boards: ['HB', 'BB', 'AI'],
        amenities: MORE_PORODICNO,
        airport: 'Solun',
      },
      {
        city: 'Solun',
        hotel: 'Thessaloniki City Hotel',
        stars: 4,
        price: 74,
        boards: ['BB'],
        amenities: GRAD,
      ...
      {
        city: 'Rodos',
        hotel: 'Rhodes Sun Village',
        stars: 5,
        price: 138,
        boards: ['AI', 'HB'],
        amenities: [...MORE_PORODICNO, 'SPA_WELLNESS', 'GYM'],
        airport: 'Rodos',
      },
      {
        city: 'Krit',
        hotel: 'Creta Blue Bay',
        stars: 5,
        price: 145,
        boards: ['AI', 'HB'],
        amenities: [...MORE_PORODICNO, 'SPA_WELLNESS'],
        airport: 'Iraklion',
      },
      {
        city: 'Zakintos',
        hotel: 'Zante Coral Bay',
        stars: 4,
        price: 108,
        boards: ['HB', 'BB'],
        amenities: MORE,
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Antalija',
        hotel: 'Lara Grand Resort',
        stars: 5,
        price: 152,
        boards: ['AI', 'FB'],
        amenities: [...MORE_PORODICNO, 'SPA_WELLNESS', 'GYM', 'BEACH_PRIVATE'],
        airport: 'Antalija',
      },
      {
        city: 'Kemer',
        hotel: 'Kemer Pine Bay',
        stars: 5,
        price: 134,
        boards: ['AI'],
        amenities: [...MORE_PORODICNO, 'BEACH_PEBBLE', 'SPA_WELLNESS'],
        airport: 'Antalija',
      },
      {
        city: 'Side',
        hotel: 'Side Ancient Resort',
        stars: 5,
        price: 128,
        boards: ['AI'],
        amenities: MORE_PORODICNO,
      ...
      {
        city: 'Bodrum',
        hotel: 'Bodrum Marina Suites',
        stars: 5,
        price: 164,
        boards: ['HB', 'BB'],
        amenities: [...MORE, 'ADULTS_ONLY', 'SPA_WELLNESS'],
        airport: 'Bodrum',
      },
      {
        city: 'Marmaris',
        hotel: 'Marmaris Blue Lagoon',
        stars: 4,
        price: 104,
        boards: ['AI', 'HB'],
        amenities: MORE_PORODICNO,
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Budva',
        hotel: 'Budva Riviera Hotel',
        stars: 4,
        price: 112,
        boards: ['HB', 'BB'],
        amenities: [...MORE, 'BEACH_PEBBLE'],
        airport: 'Tivat',
      },
      {
        city: 'Bečići',
        hotel: 'Bečići Sunset Resort',
        stars: 4,
        price: 118,
        boards: ['HB', 'AI'],
        amenities: MORE_PORODICNO,
      ...
      {
        city: 'Herceg Novi',
        hotel: 'Herceg Novi Spa Hotel',
        stars: 4,
        price: 96,
        boards: ['HB'],
        amenities: [...MORE, 'SPA_WELLNESS'],
        airport: 'Tivat',
      },
      {
        city: 'Kotor',
        hotel: 'Kotor Old Town Rooms',
        stars: 3,
        price: 82,
        boards: ['BB'],
        amenities: GRAD,
      ...
      {
        city: 'Ulcinj',
        hotel: 'Ulcinj Long Beach Resort',
        stars: 4,
        price: 88,
        boards: ['AI', 'HB'],
        amenities: MORE_PORODICNO,
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Zlatibor',
        hotel: 'Zlatibor Vista Hotel',
        stars: 4,
        price: 74,
        boards: ['HB', 'FB'],
        amenities: [...PLANINA, 'POOL_INDOOR'],
      },
      {
        city: 'Kopaonik',
        hotel: 'Kopaonik Ski Resort',
        stars: 4,
        price: 92,
        boards: ['HB', 'FB'],
        amenities: [...PLANINA, 'POOL_HEATED'],
      },
      {
        city: 'Vrnjačka Banja',
        hotel: 'Vrnjci Spa Hotel',
        stars: 4,
        price: 66,
        boards: ['FB', 'HB'],
        amenities: [...PLANINA, 'POOL_INDOOR'],
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Hurgada',
        hotel: 'Hurghada Coral Reef Resort',
        stars: 5,
        price: 118,
        boards: ['AI'],
        amenities: [...MORE_PORODICNO, 'SPA_WELLNESS', 'BEACH_PRIVATE'],
        airport: 'Hurgada',
      },
      {
        city: 'Šarm el Šeik',
        hotel: 'Sharm Bay Resort',
        stars: 5,
        price: 126,
        boards: ['AI'],
        amenities: [...MORE_PORODICNO, 'BEACH_ROCK', 'SPA_WELLNESS'],
        airport: 'Šarm el Šeik',
      },
      {
        city: 'Marsa Alam',
        hotel: 'Marsa Alam Diving Resort',
        stars: 4,
        price: 104,
        boards: ['AI'],
        amenities: MORE_PORODICNO,
  ...
  },
  {
    ...
    destinacije: [
      ...
      {
        city: 'Palma de Majorka',
        hotel: 'Mallorca Palma Bay',
        stars: 4,
        price: 132,
        boards: ['HB', 'AI'],
        amenities: MORE_PORODICNO,
        airport: 'Palma de Majorka',
      },
      {
        city: 'Tenerife',
        hotel: 'Tenerife Atlantic Resort',
        stars: 4,
        price: 138,
        boards: ['AI', 'HB'],
        amenities: [...MORE_PORODICNO, 'BEACH_ROCK'],
        airport: 'Tenerife',
      },
    ],
  },
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Dubrovnik',
        hotel: 'Dubrovnik Old Port Hotel',
        stars: 4,
        price: 156,
        boards: ['BB', 'HB'],
        amenities: [...MORE, 'BEACH_ROCK'],
        airport: 'Dubrovnik',
      },
      {
        city: 'Split',
        hotel: 'Split Riva Hotel',
        stars: 4,
        price: 128,
        boards: ['BB'],
        amenities: GRAD,
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Dubai',
        hotel: 'Dubai Marina Tower Hotel',
        stars: 5,
        price: 186,
        boards: ['BB', 'HB'],
        amenities: [...MORE, 'GYM', 'SPA_WELLNESS', 'BEACH_PRIVATE'],
        airport: 'Dubai',
      },
      {
        city: 'Abu Dabi',
        hotel: 'Abu Dhabi Corniche Hotel',
        stars: 5,
        price: 168,
        boards: ['BB', 'HB'],
        amenities: [...MORE, 'GYM', 'SPA_WELLNESS'],
        airport: 'Abu Dabi',
      },
      {
        city: 'Šardža',
        hotel: 'Sharjah Beach Resort',
        stars: 4,
        price: 112,
        boards: ['HB', 'AI'],
        amenities: MORE_PORODICNO,
  ...
  },
  {
    ...
    destinacije: [
      {
        city: 'Ohrid',
        hotel: 'Ohrid Lake View Hotel',
        stars: 4,
        price: 62,
        boards: ['HB', 'BB'],
        amenities: [...MORE, 'POOL_OUTDOOR'],
        airport: 'Ohrid',
      },
      {
        city: 'Skoplje',
        hotel: 'Skopje City Hotel',
        stars: 4,
        price: 58,
        boards: ['BB'],
        amenities: GRAD,
    ...
    for (const cabin of ['ECONOMY', 'BUSINESS'] as const) {
      ...
      await prisma.product.create({
        data: {
          ...
          sourceContractId: contract.id,
          destinationCountry:
            KATALOG.find((k) => k.destinacije.some((d) => d.airport === aerodrom))?.country ??
            'Srbija',
