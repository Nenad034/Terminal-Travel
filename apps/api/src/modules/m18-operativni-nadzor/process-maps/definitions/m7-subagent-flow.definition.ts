...
export const M7_SUBAGENT_FLOW_PROCESS_MAP: ProcessMapDefinition = {
  ...
  nodes: [
    ...
    {
      id: 'subagent-registered',
      label: 'Subagent registrovan',
      matchActions: ['subagent.registered', 'subagent.child_registered'],
    },
    { id: 'subagent-approved', label: 'Subagent odobren', matchActions: ['subagent.approved'] },
    {
      id: 'subagent-updated',
      label: 'Subagent/provizija izmenjeni',
      matchActions: ['subagent.updated', 'subagent.child_commission_updated'],
    },
    {
      id: 'commission-ceiling-warning',
      label: 'Upozorenje: plafon provizije',
      matchActions: ['subagent.commission_ceiling_warning'],
    },
    {
      id: 'rebate-created',
      label: 'Rabat na proviziju kreiran',
      matchActions: ['commission_rebate.draft_created'],
    },
