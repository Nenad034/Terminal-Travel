...
// PUBLISHED namerno izostavljen — objava ide isključivo kroz PublishButton (poseban PUBLISH
// gate, M23 spec §6/§8), da EDIT nosilac bez PUBLISH dozvole ne dobije 403 iz ove forme.
const STATUSES = ['DRAFT', 'PENDING_APPROVAL', 'ARCHIVED'];

// M23 spec §8 — PATCH /knowledge/articles/:id. EDIT dozvola dovoljna za svaki prelaz osim u
// PUBLISHED.
