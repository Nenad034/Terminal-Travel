...
function withDerived(
  row: Omit<MockBookingRow, 'paidAmount' | 'items' | 'buyerEmail' | 'buyerPhone' | 'supplierEmail' | 'supplierPhone'> & {
    paidAmount?: number;
    items?: MockBookingItem[];
    buyerEmail?: string;
    buyerPhone?: string;
...
export const MOCK_BOOKINGS: MockBookingRow[] = [
  ...
  withDerived({ bookingNumber: 'TT-2026-100053', buyerName: 'Teodora Mitrović', buyerType: 'FIZICKO_LICE', channel: 'INTERNAL_PANEL', status: 'PENDING_SUPPLIER_CONFIRMATION', paymentStatus: 'UNPAID', stayFrom: '2026-08-20', stayTo: '2026-08-27', totalPrice: 189000, currency: 'EUR', createdAt: '2026-06-13', country: 'Turska', destinationCity: 'Bodrum', hotelName: 'Voyage Bodrum', accommodationType: 'Dvokrevetna soba, Ultra All Inclusive', productType: 'ACCOMMODATION', travelers: [{ name: 'Teodora Mitrović', ageCategory: 'ADULT' }, { name: 'Aleksa Mitrović', ageCategory: 'BABY', birthYear: 2025 }], urgent: [{ reason: 'Rok za potvrdu dobavljača ističe za 24h.', target: 'SUPPLIER' }, { reason: 'Nedostaje broj pasoša za bebu (Aleksa Mitrović) — rok pre polaska.', target: 'BUYER' }], branch: 'Novi Sad', assignedUser: 'Ana Radulović', supplierName: 'Solvex', partnerName: null }),
