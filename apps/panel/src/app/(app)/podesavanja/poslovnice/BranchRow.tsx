...
export default function BranchRow({
  ...
  return (
    <form
      action={formAction}
      className="flex items-center gap-3 border-b border-border py-2 text-xs last:border-0"
    >
...
function SaveButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="rounded px-2 py-1 font-medium text-accent-strong hover:bg-accent-soft disabled:opacity-50"
    >
