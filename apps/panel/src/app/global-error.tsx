      ...
      >
        <div style={{ maxWidth: 640, margin: '10vh auto', padding: '0 24px' }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.6, color: '#b8b8b8', margin: '0 0 20px' }}>
            Greška je nastala pre nego što se aplikacija uopšte podigla, pa nije moguće prikazati
            uobičajen ekran. Vaši podaci nisu izgubljeni. Pokušajte ponovo; ako se ponovi, pošaljite
            oznaku ispod.
          </p>
