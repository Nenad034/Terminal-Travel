...
1. Pročitaj ceo `16-SPECIFIKACIJA-M9-MOBILNA-APLIKACIJA.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `16-SPECIFIKACIJA-M9-MOBILNA-APLIKACIJA.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
