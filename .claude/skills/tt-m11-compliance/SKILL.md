...
1. Pročitaj ceo `08-SPECIFIKACIJA-M11-COMPLIANCE.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `08-SPECIFIKACIJA-M11-COMPLIANCE.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
