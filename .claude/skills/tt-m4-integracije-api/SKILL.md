...
1. Pročitaj ceo `05-SPECIFIKACIJA-M4-INTEGRACIJE-API.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `05-SPECIFIKACIJA-M4-INTEGRACIJE-API.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
