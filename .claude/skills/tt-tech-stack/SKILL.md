...
TypeScript svuda · NestJS (backend) · PostgreSQL · Prisma (potvrđeno nad Drizzle-om, jul 2026) · REST + OpenAPI između modula i kanala · Event Bus (LISTEN/NOTIFY ili Redis Pub/Sub, kasnije RabbitMQ/Kafka) · Next.js (svi kanali, self-hosted Node.js na EU cloud infrastrukturi — namerno bez Vercel-ekskluzivnih funkcija zbog US CLOUD Act / EU-U.S. Data Privacy Framework) · **shadcn/ui + Radix UI nad Tailwind CSS-om** za UI komponente (M17 i svaki budući Next.js kanal, potvrđeno 29.8.2026 posle vizuelnog poređenja sa Fluent UI React i PatternFly) · self-hosted IAM (Keycloak ili Auth.js) za RBAC · pgvector + Google Gemini gemini-embedding-2 za semantičku pretragu (M21/M23, avgust 2026 — odvojeno od odloženog M-25 "semantički sloj" predloga za poslovne metrike, `docs/analize/30-PREDLOG-AI-SEMANTICKI-SLOJ.md`) · EU cloud regija, infrastruktura kao kod · Turborepo/Nx monorepo · obavezni automatski testovi + CI koji ne pušta kod bez prolaska testova.
