...
1. Pročitaj ceo `19-SPECIFIKACIJA-M18-OPERATIVNI-NADZOR.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `19-SPECIFIKACIJA-M18-OPERATIVNI-NADZOR.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
