...
1. Pročitaj ceo `03-SPECIFIKACIJA-M2-KATALOG-PROIZVODA.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `03-SPECIFIKACIJA-M2-KATALOG-PROIZVODA.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
