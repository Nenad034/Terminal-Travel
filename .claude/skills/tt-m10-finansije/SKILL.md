...
1. Pročitaj ceo `docs/moduli/M10-finansije/07-SPECIFIKACIJA-M10-FINANSIJE.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `docs/moduli/M10-finansije/07-SPECIFIKACIJA-M10-FINANSIJE.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
