...
1. Pročitaj ceo `docs/moduli/M13-bi/13-SPECIFIKACIJA-M13-BI.md` — ovo je Nivo 2 specifikacija ovog modula i jedini oslonac za kod.
...
- Nema koda bez oslonca u pisanoj specifikaciji. Ako zadatak nije pokriven `docs/moduli/M13-bi/13-SPECIFIKACIJA-M13-BI.md` — stani pre pisanja koda, dopuni spec, traži potvrdu vlasnika (Nenad), tek onda piši kod.
